package com.omk.MainScreen.ui.moviedetail
...
import com.omk.MainScreen.R.string
import com.omk.MainScreen.domain.model.Movie
import com.omk.MainScreen.domain.repo.movies
import com.omk.MainScreen.ui.components.MovieDetailAppBar
import com.omk.MainScreen.ui.dashboard.home.component.DownloadButton
import com.omk.MainScreen.ui.dashboard.home.component.PlayButton
import com.omk.MainScreen.ui.moviedetail.component.MoreLikeThis
import com.omk.MainScreen.ui.moviedetail.component.MoreMoviesCategory.MoreLikeThis
import com.omk.MainScreen.ui.moviedetail.component.MoreMoviesCategory.TrailersAndMore
import com.omk.MainScreen.ui.moviedetail.component.MoreMoviesTabs
import com.omk.MainScreen.ui.moviedetail.component.TrailersAndMore
...
private fun MovieDetailLayout(movie: Movie) {
  Row {
    Image(
      painterResource(id = R.drawable.jetflix_logo),
  ...
  Row {
    ...
    Text(
      ...
      fontSize = 12.sp,
      fontWeight = FontWeight.Light,
      color = AppTheme.colors.textSecondaryDark
    )
    Spacer(modifier = Modifier.width(10.dp))
    Box(
      modifier = Modifier
        .background(
          color = AppTheme.colors.uiLighterBackground,
    ...
    Box(
      modifier = Modifier
        .background(
          color = AppTheme.colors.progressIndicatorBg,
          shape = RoundedCornerShape(8)
        )

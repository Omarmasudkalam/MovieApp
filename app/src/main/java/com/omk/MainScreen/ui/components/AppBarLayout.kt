...
import com.omk.MainScreen.ui.anim.getTopBarColorState
import com.omk.MainScreen.ui.anim.getTopBarWidthState
import com.omk.MainScreen.ui.theme.AlphaNearOpaque
...
fun TopAppBar(
  ...
  Surface(
    ...
    TopAppBar(
      ...
      contentColor = AppTheme.colors.uiBackground.copy(alpha = AlphaNearOpaque),
      modifier = modifier
        .height(TopBarHeight)
    ) {
      Column {
    ...
    Box(
      ...
      if (showBack) {
        Icon(
          ...
          tint = AppTheme.colors.iconInteractive,
